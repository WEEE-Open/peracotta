    ...
    if isinstance(disks, list):
        for disk in disks:
            if is_product(disk):
                ...
                new_mobo["contents"].append({"features": {k: v for k, v in disk.items() if k in both+item_keys}})
            else:
        ...
        if is_product(disks):
            ...
            new_mobo["contents"].append({"features": {k: v for k, v in disks.items() if k in both+item_keys}})
        else:
